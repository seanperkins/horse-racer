  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className="fixed z-[100] bg-gray-900/95 text-white px-3 py-2 rounded-lg shadow-lg border border-gray-700 pointer-events-none w-[calc(100vw-16px)] sm:w-auto sm:min-w-[200px] max-w-[280px]"
          style={{
            left: `${position.x}px`,
            top: `${position.y}px`,
          }}
