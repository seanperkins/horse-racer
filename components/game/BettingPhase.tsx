            ...
            <div className="th-panel rounded-lg p-3 sm:p-4 md:p-6">
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm opacity-70">Pick the winner (2x-8x)</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm opacity-70">Top 3 finisher (1.5x-3x)</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm opacity-70">1st AND 2nd in order (10x)</div>
                </button>
              </div>
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-[var(--bg-secondary)] rounded">
                <h4 className="font-semibold mb-1 sm:mb-2 text-xs sm:text-sm">Potential Payout</h4>
                {betForHeart ? (
